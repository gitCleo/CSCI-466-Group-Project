...
<!---- single product details-------->     
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images-coffeeShop/Excelsa.JPG" width="100%" id="productImg">
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images-coffeeShop/ExcelsaDrink1.JPG" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="images-coffeeShop/ExcelsaDrink2.JPG" width="100%" class="small-img">
                    </div>
                   
                </div>
            </div>
            <div class="col-2">
                <p> <a href="index.html">Home</a> / <a href="products.php">Products</a> / Excelsa Coffee Beans</p>
                <h1> Excelsa Coffee Beans</h1>
                <h4>$17.99-$22.99</h4>
                <select>
